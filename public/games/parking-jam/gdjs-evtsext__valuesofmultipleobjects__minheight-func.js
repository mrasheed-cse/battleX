...
gdjs.evtsExt__ValuesOfMultipleObjects__MinHeight.forEachTemporary3 = null;

gdjs.evtsExt__ValuesOfMultipleObjects__MinHeight.forEachTotalCount3 = 0;
...
gdjs.copyArray(gdjs.evtsExt__ValuesOfMultipleObjects__MinHeight.GDObjectObjects1, gdjs.evtsExt__ValuesOfMultipleObjects__MinHeight.GDObjectObjects2);


for (gdjs.evtsExt__ValuesOfMultipleObjects__MinHeight.forEachIndex3 = 0;gdjs.evtsExt__ValuesOfMultipleObjects__MinHeight.forEachIndex3 < gdjs.evtsExt__ValuesOfMultipleObjects__MinHeight.GDObjectObjects2.length;++gdjs.evtsExt__ValuesOfMultipleObjects__MinHeight.forEachIndex3) {
gdjs.evtsExt__ValuesOfMultipleObjects__MinHeight.GDObjectObjects3.length = 0;


gdjs.evtsExt__ValuesOfMultipleObjects__MinHeight.forEachTemporary3 = gdjs.evtsExt__ValuesOfMultipleObjects__MinHeight.GDObjectObjects2[gdjs.evtsExt__ValuesOfMultipleObjects__MinHeight.forEachIndex3];
gdjs.evtsExt__ValuesOfMultipleObjects__MinHeight.GDObjectObjects3.push(gdjs.evtsExt__ValuesOfMultipleObjects__MinHeight.forEachTemporary3);
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.evtsExt__ValuesOfMultipleObjects__MinHeight.GDObjectObjects3.length;i<l;++i) {
    if ( gdjs.evtsExt__ValuesOfMultipleObjects__MinHeight.GDObjectObjects3[i].getHeight() < eventsFunctionContext.localVariables[0].getFromIndex(0).getAsNumber() ) {
...
{eventsFunctionContext.localVariables[0].getFromIndex(0).setNumber((( gdjs.evtsExt__ValuesOfMultipleObjects__MinHeight.GDObjectObjects3.length === 0 ) ? 0 :gdjs.evtsExt__ValuesOfMultipleObjects__MinHeight.GDObjectObjects3[0].getHeight()));
}
}
}
...
};gdjs.evtsExt__ValuesOfMultipleObjects__MinHeight.eventsList2 = function(runtimeScene, eventsFunctionContext) {
...
variables._declare("MinHeight", variable);
}
...
{eventsFunctionContext.localVariables[0].getFromIndex(0).setNumber((( gdjs.evtsExt__ValuesOfMultipleObjects__MinHeight.GDObjectObjects1.length === 0 ) ? 0 :gdjs.evtsExt__ValuesOfMultipleObjects__MinHeight.GDObjectObjects1[0].getHeight()));
}

{ //Subevents
gdjs.evtsExt__ValuesOfMultipleObjects__MinHeight.eventsList1(runtimeScene, eventsFunctionContext);} //End of subevents
}
...
gdjs.evtsExt__ValuesOfMultipleObjects__MinHeight.eventsList2(runtimeScene, eventsFunctionContext);
gdjs.evtsExt__ValuesOfMultipleObjects__MinHeight.GDObjectObjects1.length = 0;
gdjs.evtsExt__ValuesOfMultipleObjects__MinHeight.GDObjectObjects2.length = 0;
gdjs.evtsExt__ValuesOfMultipleObjects__MinHeight.GDObjectObjects3.length = 0;
