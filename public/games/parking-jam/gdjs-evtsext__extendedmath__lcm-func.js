...
gdjs.evtsExt__ExtendedMath__Lcm.idToCallbackMap = new Map();


gdjs.evtsExt__ExtendedMath__Lcm.userFunc0x11f3e98 = function GDJSInlineCode(runtimeScene, eventsFunctionContext) {
"use strict";
function gcf(a, b) {
    while (a != b) {
        if (a > b) {
...
gdjs.evtsExt__ExtendedMath__Lcm.userFunc0x11f3e98(runtimeScene, eventsFunctionContext);
